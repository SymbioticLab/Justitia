...
cycles_t lat_arr[Ntask];
cycles_t tcompleted[Ntask];
cycles_t tposted[Ntask];
cycles_t test1[Ntask];
cycles_t test2[Ntask];
...
int main(int argc, char **argv)
{
  ...
  //checkpoint(5);
  measure_time(argv[6], START_cycle);
  /*
