...
// NOTENOTE: in this version client always performs RDMA_WRITE_WITH_IMM no matter which mode (write/read) user specify
...
int on_connection(struct rdma_cm_id *id)
{
  ...
  send_info(id->context); // send info of data to server
  printf("Info message sent to the server.\n");
  checkpoint(9);
